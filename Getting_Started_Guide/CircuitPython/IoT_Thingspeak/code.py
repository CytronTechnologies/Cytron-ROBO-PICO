"""
DESCRIPTION:
This example code will uses: Robo Pico and Raspberry Pi Pico W to send data to Thingspeak.
...
REFERENCE:
https://github.com/CytronTechnologies/MAKER-PI-PICO/blob/main/Example%20Code/CircuitPython/IoT/thingspeak.py
"""
